...
namespace Code_Crafters_Interface_Prototype_1.Business
{
    public partial class UpdateStaffDetailsForm : Form
    {
        ...
        public UpdateStaffDetailsForm(int staffID, string firstName, string lastName, string email, string phone, string address)
        {
            _staffID = staffID;
        ...
        {
            this.Text = "REGAL INN - UPDATE STAFF PERSONAL DETAILS";
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    string query = @"UPDATE [GroupPmb2].[dbo].[Staff] 
                                     SET [staff_First_Name] = @FirstName, 
                                         [staff_Surname] = @LastName, 
                                         [staff_Email] = @Email, 
                ...
                MessageBox.Show("Staff personal details updated successfully!", "Update Successful", MessageBoxButtons.OK, MessageBoxIcon.Information);
                this.DialogResult = DialogResult.OK;
                this.Close();
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error updating staff details: " + ex.Message, "Database Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}