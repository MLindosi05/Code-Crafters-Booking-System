...
namespace Code_Crafters_Interface_Prototype_1.Business
{
    public partial class RoomManagementForm : Form
    {
        ...
        private void RoomManagementForm_Load(object sender, EventArgs e)
        {
            ...
            // Load initial room data based on whatever hardcoded item is currently selected
            string initialBranch = cmbBranches.SelectedItem?.ToString() ?? cmbBranches.Text;
            LoadRoomData(initialBranch);

            // Wire up selection events
            cmbBranches.SelectedIndexChanged += cmbBranches_SelectedIndexChanged;
            cmbBranches.SelectionChangeCommitted += cmbBranches_SelectionChangeCommitted;
        }
