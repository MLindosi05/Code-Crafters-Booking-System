...

    {
...

        {
...

            {
                ...
                // Revert back to the primary table to allow standard state refreshes
            ...
            // Fix: Only build and bind DataView if a text filter actually exists
...

            {
                ...
                // If no filter text exists, keep it tied directly to the updated data source table
