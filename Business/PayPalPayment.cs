    ...
    public partial class PayPalPayment : Form
    {
        ...
        private void btnProcessPayment_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("PayPal payment processed successfully. Booking is now Booked!", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                this.DialogResult = DialogResult.OK;
                this.Close();
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error processing PayPal payment: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        {
            // TODO: Implement your SQL update command or database service call here.
